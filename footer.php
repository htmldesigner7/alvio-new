<footer>
    <div class="footer-wrapper p-x">
        <div class="footer-item">
            ...
            <p class="text--white pt-3">Lorem ipsum dolor sit amet consectetur. Sit amet sed varius ut ac tincidunt
                pharetra neque. Leo feugiat neque pe</p>
    ...
    <div class="bottom-footer">
        <div class="bottom-footer-wrapper p-x">
            <div class="social-icons">
                <a href="javascript:void(0)" rel="nofollow"><img src="./images/linkedin-icon.svg" alt="LinkedIn"
                        class="me-3"></a>
                <a href="javascript:void(0)" rel="nofollow"><img src="./images/insta-icon.svg" alt="Instagram"
                        class="me-3"></a>
                <a href="javascript:void(0)" rel="nofollow"><img src="./images/facebook-icon.svg" alt="Facebook"
                        class="me-3"></a>
                <a href="javascript:void(0)" rel="nofollow"><img src="./images/whatsapp-icon.svg" alt="WhatsApp"
                        class="me-3"></a>
            </div>
            <div class="footer-content ">
                <p class="text-white mb-0">© 2026 Alvio Pharma. All Rights Reserved.</p>
            </div>
            <div class="footer-content">
