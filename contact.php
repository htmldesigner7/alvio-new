        ...
        <div class="col-lg-5">
            <div class="contact_left com_bg_light_blue">
                <div class="contact_left_child">
                    ...
                    <div class="con_links">
                        <span><svg width="37" height="37" viewBox="0 0 37 37" fill="none"
                ...
                <div class="row gx-lg-5">
                    ...
                    <div class="col-lg-12">
                        <div class="contact_items">
                            ...
                            <textarea placeholder="Write your requirements" rows="1"></textarea>
                        </div>
                    </div>

                    <div class="col-lg-12">
                        <div class="contact_items">
                            <a href="#" class="commo-btn bg-black btn-color-white">Submit </a>
                            <a href="#" class="commo-btn-arrow bg-black btn-color-white"><svg width="15" height="15"
