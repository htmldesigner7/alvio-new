    ...
    <div class="page-header-content">
        <div class="page-header-text com_bg_blue">
            ...
            <p class="text-white page-header-para">The story of Alvio Pharma is one of scientific conviction. What began
                as a dedicated effort to bridge the gap in chronic care has evolved into a multi-national presence,
                driven by the belief that every patient deserves access to the highest standards of formulation science.
            </p>
        </div>
...
<section class="line-img-section mt-100">
    <img src="./images/line-img.png" alt="line img" class="line-img">
