...
<section class="find_brand p-x mt-100">
    ...
    <div class="search-wrapper">
        <svg class="search-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
            ...
            <path d="M19 19L14.65 14.65" stroke="#999" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" />
        </svg>
        <input type="text" class="search-input" placeholder="Search product" aria-label="Search products">
    </div>
            ...
            <div class="brand_item">
                <div class="brand_item_lt">
                    ...
                    <div class="brand_item_content">
                        <h4 class="title-34" style="color:var(--black-color);">Rasafin Dusting Powder</h4>
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur. Lectus ante lobortis dictum iaculis.</p>
                    </div>
                </div>
