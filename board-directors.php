...
<section class="page-header">
    ...
    <div class="page-header-content p-x">
        <div class="page-header-text com_bg_blue">
            ...
            <p class="text-white page-header-para">Alvio’s Board of Directors provides strategic direction and
                governance oversight guiding responsible growth, ethical practices, and long-term value creation across
...
<section class="p-x mt-100">
        <div class="mb-40 text-center">
            <h2 class="title-54 mb-40">Board Leadership Guiding Governance, Accountability, and Growth</h2>
        ...
        <div class="testimonial-container">
            ...
            <div class="profile-card">
                <img class="img-fluid profile-img" src="./images/leadership.webp" alt="leadership">
