...
<section class="page-header">
    ...
    <div class="page-header-content p-x">
        <div class="page-header-text com_bg_blue">
            <p class="text-white">Home / Who We Are / Sustainability & Responsibility</p>
            <h1 class="title-34 text--white mb-3">Responsible Healthcare. Sustainable Impact.</h1>
            <p class="text-white page-header-para">At Alvio Pharma, science is the foundation of everything we create.
                Our innovation ecosystem brings together research expertise, analytical precision, and therapeutic
                insight to develop formulations that are effective, safe, and aligned with real-world clinical needs.
            </p>
        </div>
    ...
    <div class="row align-items-center">
        <div class="col-xl-4 col-lg-4 col-md-12">
            <div class="mastering_img">
                <img class="img-fluid" src="images/mastering.png" alt="Mastering">
            </div>
        </div>
        <div class="col-xl-8 col-lg-7 col-md-12">
            ...
            <p>Our sustainability approach is structured, measurable, and aligned with responsible healthcare delivery.
                We focus on strengthening ethical governance, improving operational efficiency, and working with
                accountable partners across our supply network. By embedding responsible practices into planning,
                procurement, quality oversight, and distribution readiness, we aim to reduce environmental impact while
                upholding consistency, compliance, and patient trust.</p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 ps-md-5">
                    <div class="mb-40">
                        ...
                        <p>Alvio’s purpose, Improving Lives, is reflected in how we serve patients and healthcare
                            professionals
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-md-7">
                <div class="state-content">
                    <h2 class="title-54 title--blue mb-5">Our Principles: The DNA of Discovery.</h2>
                    <p>Our manufacturing and research philosophy is guided by core values that reflect our dedication to
                        patients, healthcare professionals, and global wellness.</p>
                </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    <p>Understanding the patient's biological struggle to create kinder, more effective
                                        chemistry.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                <img src="images/new_test.png" alt="images" class="img-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-md-7">
                <div class="state-content">
                    ...
                    <p>At Alvio Pharma, responsibility is part of our everyday culture, not a one-time commitment. It
                        ...
                        across the markets we serve. Guided by our purpose of Improving Lives, we focus on ethical
                            ...
                            <h4 class="accordion-header" id="headingOne">
                                <button class="accordion-button title-34" type="button" data-bs-toggle="collapse"
                                  ...
                                  <img src="./images/men-icon.png" alt="men icon">
                                    <span>Action That Reflects Our Values</span>
                                </button>
                            </h4>
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>
                                        We turn intent into action through ethical market practices, patient-first
                                        thinking, and responsible stakeholder engagement. From leadership decisions to
                                        daily execution, we prioritise trust, transparency, and consistency.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h4 class="accordion-header" id="headingTwo">
                                <button class="accordion-button title-34 collapsed" type="button"
                                    ...
                                    <img src="./images/men-icon.png" alt="men icon">
                                    <span> Adaptability with Accountability</span>
                                </button>
                            </h4>
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
            ...
            <div class="col-md-4">
                <div class="vision-mission-item">
                    ...
                    <img src="./images/heart-icon-2.png" class="img-fluid heart-icon" alt="Focus Icon">
                    ...
                    <img src="./images/puzzle-icon.png" class="img-fluid puzzle-icon" alt="Heart Icon">
